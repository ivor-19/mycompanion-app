...
export default function Home() {
  return (
    <ScrollView style={{flexGrow: 1}}>
      <View className="min-h-screen bg-white items-center w-full gap-4">
        <View className="bg-white min-h-48 rounded-b-[30px] pt-14 px-6 pb-6 flex-col gap-4 w-full" style={{elevation: 4, shadowColor: 'gray'}}>
          ...
          <View className="flex-row items-center gap-4">
            <View className="h-16 w-16" style={{borderRadius: '100%'}}>
              <Image source={require('../../assets/avatars/bot.png')} contentFit="contain" style={{width: '100%', height: '100%', borderRadius: 60}}/> 
            </View>
            <View>
        ...
        >
          ...
          <View className="w-[40%] h-full flex items-center justify-end ">
            <Image
              source={require('../../assets/avatars/main.png')}
          ...
          <View className="w-[60%] flex-col justify-center items-end gap-4 ">
            ...
            {/* <Button text="Chat Now" style="h-12 w-[8em] bg-[#f5576c]" fontStyle="text-sm text-white" onPress={() => router.push('/support')}/> */}
          </View>
        </LinearGradient>
      </View>
    </ScrollView>
